<template>
  <div
    class="min-h-screen flex items-center justify-center bg-gradient-to-r from-blue-900 to-gray-900 p-4"
  >
    <div class="w-full max-w-3xl bg-white rounded-2xl shadow-2xl p-8">
      ...
      <p class="text-gray-500 text-center mb-6">
        Completa los 3 pasos para crear tu cuenta
      </p>
      ...
      <div class="flex justify-between mt-8">
        <button
          ...
          @click="prevStep"
          class="px-6 py-2 rounded-lg border border-gray-400 text-gray-600 hover:bg-gray-100 transition disabled:opacity-40 flex items-center gap-2"
        >
          ← Atrás
        </button>
        ...
        <div>
          <button
            ...
            class="px-6 py-2 rounded-lg bg-gradient-to-r from-blue-600 to-blue-800 text-white font-semibold shadow hover:scale-105 transition disabled:opacity-40 flex items-center gap-2"
          >
            Siguiente →
          </button>
          ...
          <button
            ...
            @click="submitForm"
            :disabled="!isCurrentStepValid"
            class="px-6 py-2 rounded-lg bg-gradient-to-r from-green-500 to-green-700 text-white font-semibold shadow hover:scale-105 transition disabled:opacity-40 flex items-center gap-2"
          >
            Enviar ✅
          </button>
        </div>
  ...
  methods: {
    ...
    formatFormData() {
      return {
        ...
        dob: this.form.dob,
        docType: this.form.docTуре,
        docNumber: this.form.docNumber,
        docFront: this.form.docFront,
        docBack: this.form.docBack,
    ...
    submitForm() {
      if (this.isCurrentStepValid) {
        console.log("FORM DATA:", this.formatFormData());
        this.showModal = true;
      }
    },
